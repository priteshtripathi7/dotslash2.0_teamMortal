...
function (_React$Component) {
  ...
  function App() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(App)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.state = {
      ...
      //   name: "vartik"
      // });
      fetch("https://pokeapi.co/api/v2/pokemon/" + _this.state.name).then(function (data) {
        return data.json();
      }).then(function (json) {
        console.log(json);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement("h1", null, this.state.name), _react.default.createElement("button", {
        className: "button",
        onClick: this.handleClick
      }, "click me!!"), _react.default.createElement("input", {
        type: "text",
        className: "textfield",
